...
#undef FIR_MAX_FINGER_VIEW_COUNT_PER_FINGER
...
const NInt N_DEPRECATED("deprecated, use FIR_MAX_FINGER_VIEW_COUNT_PER_FINGER_2_0 or FIR_MAX_FINGER_VIEW_COUNT_PER_FINGER_2_5 instead.") FIR_MAX_FINGER_VIEW_COUNT_PER_FINGER = 16;
const NInt N_DEPRECATED("deprecated, use FIR_MAX_FINGER_COUNT_1_0 instead.") FIR_MAX_FINGER_COUNT = 255;
const NInt N_DEPRECATED("deprecated, use FIR_MAX_FINGER_VIEW_COUNT_1_0 instead.") FIR_MAX_FINGER_VIEW_COUNT = FIR_MAX_FINGER_COUNT_1_0 * FIR_MAX_FINGER_VIEW_COUNT_PER_FINGER_1_0;
