...
from libs.enhancing import ridge_orient, ridge_segment

class Fingerprint():
    def __init__(self, fingerprint, block_size):
        self.block_size = block_size
        self.fingerprint, self.mask = ridge_segment(self.addWhiteBorder(self.getGrayScaleNormalized(fingerprint), block_size), block_size)
